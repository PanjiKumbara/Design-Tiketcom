      ...
      >
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormMessage />
                <FormControl>
                  <Input placeholder="Jakarta, ID" {...field} />
                </FormControl>
              </FormItem>
            )}
          />
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormMessage />
                <FormControl>
                  <Input placeholder="Surabaya, ID" {...field} />
                </FormControl>
              </FormItem>
            )}
          />
        ...
        <div className="flex w-full items-center space-x-2">
          ...
          <div className="mt-auto">
            <Button
              type="submit"
              className="bg-blue-500  hover:bg-white hover:text-black text-base"
            >
              <a onClick={PostForm} type="button">
                Cari
              </a>
            </Button>
          </div>
