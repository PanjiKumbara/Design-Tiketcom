...
const products = [
  {
    name: "Tiket Pesawat",
    description: "Segera pesan sekarang!",
    href: "#",
...
const callsToAction = [
  { name: "Tutorial Cara Pesan", href: "#", icon: PlayCircleIcon },
  ...
  return (
    <header className="bg-[#0064d3]">
      ...
      >
        <div className="flex lg:flex-1">
          <Link href="/" className="-m-1.5 p-1.5">
            <span className="sr-only">tiket.com</span>
            <img
              className="h-12 w-auto"
              src="https://d1fdloi71mui9q.cloudfront.net/bUR8JxjyRxWJZc3PjceH_Icon-200.png"
              alt=""
            />
          </Link>
        </div>
                ...
                <div className="p-4">
                  {products.map((item) => (
                    ...
                    >
                      ...
                      >
                        <item.icon
                          className="h-6 w-6 text-[#0064d3] group-hover:text-blue-600"
                          aria-hidden="true"
                        />
                      </div>
                      <div className="flex-auto">
                        <a
                          href={item.href}
                          className="block font-bold text-[#0064d3]"
                        >
                          {item.name}
                          <span className="absolute inset-0" />
                        </a>
                        <p className="mt-1 text-[#0064d3]">
                          {item.description}
                        </p>
                      </div>
                    </div>
                  ...
                  {callsToAction.map((item) => (
                    <a
                      ...
                      className="flex items-center justify-center gap-x-2.5 p-3 text-sm
                        font-semibold leading-6 text-[#0064d3] hover:bg-gray-100"
                    >
                      <item.icon
                        className="h-5 w-5 flex-none text-[#0064d3]"
                        aria-hidden="true"
                      />
                      {item.name}
                    </a>
      ...
      >
        ...
        overlow-y-auto bg-[#0064d3] px-6 py-6 sm:max-w-sm sm:ring-1
        sm:ring-gray-900/10"
        >
